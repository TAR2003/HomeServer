      ...
      <main className="container mx-auto px-4 py-8">
        {loading ? (
          ...
          <>
            ...
            <MediaGrid files={filteredFiles} onPlayVideo={setSelectedVideo} onDelete={loadFiles} />
          </>
        )}
      </main>
    ...
    <div className="min-h-screen bg-background">
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link key={cat.id} to={`/category/${cat.id}`}>
                  <Button variant={categoryId === cat.id ? 'primary' : 'ghost'}>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <MediaGrid files={files} onPlayVideo={setSelectedVideo} onDelete={loadCategoryFiles} />
        )}
      </main>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Select Category and Upload</CardTitle>
          </CardHeader>
        <CardContent>
